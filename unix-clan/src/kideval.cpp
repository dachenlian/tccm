...
void usage() {
	...
	puts("+qN: change the minimum limit of utterance for DSS and IPSYN (default: DSS=50, IPSYN=100)");
...
static void kideval_pr_result(void) {
	...
	excelCommasStrCell(fpout, "MLU_Utts,MLU_Words,MLU_Morphemes,MLU100_Utts,MLU100_Words,MLU100_Morphemes");
